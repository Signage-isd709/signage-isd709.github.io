      ...
      success: function(data) {
        ...
        $.each(data.items, function(e, item) {
          ...
          var summary = item.summary || '';
					...
					$($div).append('<div name="eventWrapper" class="slide" style="margin-left: 5px;"><table><td><div name="eventIcon" align="left">' + calIcon + '</div></td><td><div name="eventInfo">' + s + '</div></td></table>');
        });
      },
