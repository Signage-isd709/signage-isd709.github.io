et=1458320278;function f0(d){return sd1[d.getUTCDay()]+', '+sm[d.getUTCMonth()]+' '+d.getUTCDate()+', '+d.getUTCFullYear()+'<br>'+((d.getUTCHours()+11)%12+1)+':'+p2(d.getUTCMinutes())+':'+p2(d.getUTCSeconds())+' '+_ap(d);}
cks={t1:{t:[{"o":-18000,"a":"CDT","d":1}],f:f0}};sm=[];sm[2]='Mar';sd1=['Sun','Mon','Tue','Wed','Thu','Fri','Sat'];
